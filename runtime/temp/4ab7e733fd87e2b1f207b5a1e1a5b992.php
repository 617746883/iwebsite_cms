    ...
    <div class="page-content">
        <form action="" method="post" class="form-horizontal form-validate" enctype="multipart/form-data" >
            <div class="form-group">
                <label class="col-lg control-label">网站标题</label>
                <div class="col-sm-9 col-xs-12">
                    <input type="text" name="data[name]" class="form-control" value="<?php echo $data['name']; ?>" required/>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="col-lg control-label">网站海报</label>
                <div class="col-sm-9 col-xs-12">
            ...
            <div class="form-group">
                <label class="col-lg control-label">图片水印</label>
                <div class="col-sm-9 col-xs-12">
                    <label class="radio-inline">
                        <input type="radio" name="data[iswater]" value='1' <?php if($data['iswater']==1): ?>checked<?php endif; ?> /> 开启
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="data[iswater]" value='0' <?php if($data['iswater']==0): ?>checked<?php endif; ?> /> 关闭
                    </label>
                </div>
            </div>          
            <div class="form-group">
                <label class="col-lg control-label">图片水印</label>
                <div class="col-sm-9 col-xs-12">
                    <?php echo tpl_form_field_image2('data[imgwater]', $data['imgwater']); ?>
                    <span class='help-block'>图片水印，建议尺寸200*200，空则不显示</span>
                </div>
            </div>
            <div class="form-group">
