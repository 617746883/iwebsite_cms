<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/pc/default/tpl_list\newlist.html";i:1551763586;s:60:"D:\phpStudy\WWW\iwebsite\template\pc\default\_head_base.html";i:1551762885;s:57:"D:\phpStudy\WWW\iwebsite\template\pc\default\_header.html";i:1551763778;s:57:"D:\phpStudy\WWW\iwebsite\template\pc\default\_footer.html";i:1551433387;}*/ ?>
<!DOCTYPE html>
...
<header class="header navbar-fixed-top">
    ...
    <!-- Navbar -->
        ...
        <div class="bg-color-sky-light" data-auto-height="true">
            <div class="content-lg container">
                <div class="row row-space-1 margin-b-2">
                    <?php if(is_array($contentlist) || $contentlist instanceof \think\Collection || $contentlist instanceof \think\Paginator): if( count($contentlist)==0 ) : echo "" ;else: foreach($contentlist as $k=>$item): ?>
                    <div class="col-sm-6 sm-margin-b-2">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".<?php echo $k + 1; ?>s">
                            <div class="service" data-height="height">
                                <h3><?php echo $item['title']; ?></h3>
                                <p class="margin-b-5"><?php echo $item['description']; ?></p>
                                <a href="<?php echo $item['url']; ?>" class="content-wrapper-link"></a>    
                            </div>
                        </div>
                    </div>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
        ...
        <div class="content-lg container">
            ...
            <div class="row">
                <?php $think_table = "content";$think_where = "status = 1 and deleted = 0 and isrecommand = 1";$think_order = "displayorder desc";$think_limit = "1";$think_db_info = db($think_table)->where($think_where)->order($think_order)->paginate($think_limit);$think_page = $think_db_info->render(); if(is_array($think_db_info) || $think_db_info instanceof \think\Collection || $think_db_info instanceof \think\Paginator): $i = 0; $__LIST__ = $think_db_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                ...
                <div class="col-sm-4 col-sm-offset-1">
                    <img class="img-responsive" src="<?php echo $v['thumb']; ?>" alt="Our Office">
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <!--// end row -->
