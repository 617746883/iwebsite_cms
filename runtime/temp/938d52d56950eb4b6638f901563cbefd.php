...
<div class="page-content">
    <form action="" method="get" class="form-horizontal" user="form">
        <div class="page-toolbar">
            <div class="col-sm-6">
                <span class="">
                    <a class='btn btn-primary btn-sm' href="<?php echo url('admin/system/adminadd'); ?>"><i class="fa fa-plus"></i> 添加新操作员</a>
                </span>
            </div>
                    ...
                    <div class="input-group">
                        <span class="input-group-selectn">
                          <select name="roleid" class='form-control'>
                              <option value="" <?php if($roleid==''): ?> selected<?php endif; ?>>角色</option>
                              <option value="0" <?php if($roleid=='0'): ?> selected<?php endif; ?>>无角色</option>
                              ...
                              <option value="<?php echo $role['id']; ?>" <?php if($roleid== $role['id']): ?> selected<?php endif; ?>><?php echo $role['rolename']; ?></option>
                              <?php endforeach; endif; else: echo "" ;endif; ?>
                          </select>
                        </span>
    ...
    <?php if(count($list)>0): ?> 
        <div class="page-table-header">
            <input type='checkbox' />
            <div class="btn-group">
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch' data-href="<?php echo url('admin/system/adminstatus',array('status'=>1)); ?>">
                    <i class='icow icow-qiyong'></i> 启用</button>
                </button>
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch'  data-href="<?php echo url('admin/system/adminstatus',array('status'=>0)); ?>">
                    <i class='icow icow-jinyong'></i> 禁用</button>
                </button>
                <button class="btn btn-default btn-sm btn-operation" type="button" data-toggle='batch-remove' data-confirm="确认要删除?" data-href="<?php echo url('admin/system/admindelete'); ?>">
                ...
                <tr>
                    ...
                    <td>
                       <span class='label <?php if($row['status']==1): ?>label-primary<?php else: ?>label-default<?php endif; ?>'
                          ...
                          data-switch-value0='0|禁用|label label-default|<?php echo url('admin/system/adminstatus',array('status'=>1,'id'=>$row['id'])); ?>'  
                          data-switch-value1='1|启用|label label-success|<?php echo url('admin/system/adminstatus',array('status'=>0,'id'=>$row['id'])); ?>'  
                        >
                          <?php if($row['status']==1): ?>启用<?php else: ?>禁用<?php endif; ?></span>
                    </td>
                    <td>
                        <a class='btn btn-default btn-sm  btn-op btn-operation' href="<?php echo url('admin/system/adminedit', array('id' => $row['id'])); ?>">
                            <span data-toggle="tooltip" data-placement="top" title="" data-original-title="编辑">
                                <i class="icow icow-bianji2"></i>
                            </span>
                        </a>
                        <a class='btn btn-default btn-sm btn-op btn-operation' data-toggle='ajaxRemove'  href="<?php echo url('admin/system/admindelete', array('id' => $row['id'])); ?>" data-confirm="确认删除此操作员吗？">
...
<script language='javascript'> 
    function search_users() {
        ...
        $.get('<?php echo url('admin/system/adminquery');; ?>', {
