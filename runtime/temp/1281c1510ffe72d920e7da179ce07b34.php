...
<div class="page-content transparent">
        ...
        <div class="col-md-4">
            <div class="ibox h300">
                <div class="ibox-title">
                    <h5><i class="icow icow-shop"></i>网站信息</h5>
                    <ul >
                        <a href="<?php echo url('admin/sysset/index'); ?>" class="text-primary">修改</a>
                    </ul>
                </div>
                <div class="ibox-content">
                    <ul class="fui-cell-group">
                        <li class="fui-cell">网站名称：<span class="text"><?php echo isset($iwebsiteset['name']) ? $iwebsiteset['name'] : ''; ?></span></li>
                        <li class="fui-cell">网站介绍：<span class="text"><?php echo isset($iwebsiteset['description']) ? $iwebsiteset['description'] : ''; ?></span></li>
                        <li class="fui-cell">网站状态：<span class='text'><?php if((!empty($iwebsiteset['close']['flag']))): ?>关闭<?php else: ?>正常<?php endif; ?></span></li>
                    </ul>
                </div>
            </div>
        </div>
                ...
                <div class="ibox-content  no-border">
                    <ul class="fui-list-group">
                        <li class="fui-list">
                            <a href="<?php echo url('admin/content/index'); ?>">
                                <div class="fui-list-media">
                                    <span class="icow text-info icow-page"></span>
                                </div>
                                <div class="fui-list-inner">
                                    <h5 class="goods_totals"><?php echo $content; ?></h5>
                                    <p>内容数量</p>
                                </div>
                            </a>
                        </li>
                        <li class="fui-list">
                            <a href="<?php echo url('admin/column/index'); ?>">
                                <div class="fui-list-media">
                                    <span class="icow text-green icow-tuihuo"></span>
                                </div>
                                <div class="fui-list-inner">
                                    <h5 class="order_status1"><?php echo $column; ?></h5>
                                    <p>栏目总数</p>
                                </div>
                            </a>
                        </li>
                        <li class="fui-list">
                            <a href="<?php echo url('admin/extend/link'); ?>">
                                <div class="fui-list-media">
                                    <span class="icow text-primary icow-huifu"></span>
                                </div>
                                <div class="fui-list-inner">
                                    <h5 class="order_status4"><?php echo $link; ?></h5>
                                    <p>友情链接</p>
                                </div>
                            </a>
                        </li>
                        <li class="fui-list">
                            <a href="<?php echo url('admin/extend/comment'); ?>">
                                <div class="fui-list-media">
                                    <span class="icow text-warning icow-pingjia"></span>
                                </div>
                                <div class="fui-list-inner">
                                    <h5 class="finance_total"><?php echo $comment; ?></h5>
                                    <p>留言反馈</p>
                                </div>
                            </a>
                        </li>
    ...
    <div class="row">
                ...
                <div class="ibox-content">
                    <div class="tab-content" style="height: auto;">
                        <table class="table">
                            ...
                            <tr>
                                <th>作者QQ</th>
                                <td><a href="tencent://message/?Site=baidu.com&uin=617746883&Menu=yes" target="_blank">SUL1SS[617746883]</a></td>
                            </tr>
                            <tr>
                                <th>作者微信</th>
                                <td>ao9396</td>
        ...
        <div class="col-md-6">
            <div class="ibox h300">
                <div class="ibox-title">
                    <h5><i class="icow">&#xe615;</i>系统信息</h5>
                </div>
                <div class="ibox-content">
                    <table class="table">
                        <tr>
                            <th>核心版本</th>
                            <td>SUL1SSCMS v1.0</td>
                        </tr>
                        <tr>
                            <th>服务器操作系统</th>
                        ...
                        <tr>
                            <th>系统版权所有</th>
                            <td>
                                <a href="tencent://message/?Site=baidu.com&uin=617746883&Menu=yes">SUL1SS</a>
                            </td>
                        </tr>
                    </table>
                </div>
