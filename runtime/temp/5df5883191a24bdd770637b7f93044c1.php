<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:29:"./template/pc/farm/index.html";i:1551755700;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>Home</title>
...
<!-- //custom-theme -->
<link href="/template/pc/farm/static/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="/template/pc/farm/static/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script type="text/javascript" src="/template/pc/farm/static/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<link href="/template/pc/farm/static/css/mislider.css" rel="stylesheet" type="text/css" />
<link href="/template/pc/farm/static/css/mislider-custom.css" rel="stylesheet" type="text/css" />
<!-- font-awesome-icons -->
<link href="/template/pc/farm/static/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome-icons -->
		...
		<div class="container">
			<div class="w3_agileits_banner_main_grid">
				<div class="w3_agile_logo">
					<h1><a href="<?php echo url('/'); ?>"><span>Tea</span>Lalong<i>Grow healthy products</i></a></h1>
				</div>
				<div class="agile_social_icons_banner" style="display: none;">
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<img src="/template/pc/farm/static/images/4.jpg" alt=" " class="img-responsive" />
	...
	<div class="welcome">
		<div class="container">
			...
			<div class="w3_agile_image">
				<img src="/template/pc/farm/static/images/1.png" alt=" " class="img-responsive" />
			</div>
		...
		<div class="mis-stage w3_agileits_welcome_grids"> 
			...
			<ol class="mis-slider">
				<li class="mis-slide"> 
					<figure> 
						<img src="/template/pc/farm/static/images/2.png" alt=" " class="img-responsive" />
						<figcaption>Strawberry</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="/template/pc/farm/static/images/3.png" alt=" " class="img-responsive" />
						<figcaption>Orange</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="/template/pc/farm/static/images/4.png" alt=" " class="img-responsive" />
						<figcaption>Pomegranates</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="/template/pc/farm/static/images/5.png" alt=" " class="img-responsive" />
						<figcaption>Lemon</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="/template/pc/farm/static/images/6.png" alt=" " class="img-responsive" />
						<figcaption>Kiwi Fruits</figcaption>
					</figure>
				</li>
				<li class="mis-slide"> 
					<figure> 
						<img src="/template/pc/farm/static/images/7.png" alt=" " class="img-responsive" />
		...
		<div class="col-md-6 wthree_welcome_bottom_left">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="/template/pc/farm/static/images/8.png" alt=" " class="img-responsive" />
				</div>
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="/template/pc/farm/static/images/9.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="/template/pc/farm/static/images/10.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="/template/pc/farm/static/images/11.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="w3ls_news_grids">
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="/template/pc/farm/static/images/3.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="/template/pc/farm/static/images/6.jpg" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>plantation</h3></div>
						</div>
					</div>
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="/template/pc/farm/static/images/5.jpg" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>plantation</h3></div>
						</div>
					</div>
...
<!-- newsletter -->
	<div class="newsletter">
		<div class="container">
			...
			<div class="w3_agile_image">
				<img src="/template/pc/farm/static/images/12.png" alt=" " class="img-responsive">
			</div>
			...
			<div class="w3agile_footer_grids">
				...
				<div class="col-md-3 agileinfo_footer_grid">
					...
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="/template/pc/farm/static/images/6.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="/template/pc/farm/static/images/2.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="/template/pc/farm/static/images/5.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="agileinfo_footer_grid_left">
						<a href="#" data-toggle="modal" data-target="#myModal"><img src="/template/pc/farm/static/images/3.jpg" alt=" " class="img-responsive" /></a>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class="clearfix"> </div>
...
<!-- //footer -->
<!-- stats -->
	<script src="/template/pc/farm/static/js/jquery.waypoints.min.js"></script>
	<script src="/template/pc/farm/static/js/jquery.countup.js"></script>
		<script>
			$('.counter').countUp();
		</script>
<!-- //stats -->
<!-- mislider -->
	<script src="/template/pc/farm/static/js/mislider.js" type="text/javascript"></script>
...
<!-- //mislider -->
<!-- text-effect -->
		<script type="text/javascript" src="/template/pc/farm/static/js/jquery.transit.js"></script> 
		<script type="text/javascript" src="/template/pc/farm/static/js/jquery.textFx.js"></script> 
		<script type="text/javascript">
...
<script type="text/javascript" src="/template/pc/farm/static/js/move-top.js"></script>
<script type="text/javascript" src="/template/pc/farm/static/js/easing.js"></script>
<script type="text/javascript">
...
<!-- for bootstrap working -->
	<script src="/template/pc/farm/static/js/bootstrap.js"></script>
<!-- //for bootstrap working -->
