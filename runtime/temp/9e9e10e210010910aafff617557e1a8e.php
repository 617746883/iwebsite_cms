<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/pc/default/tpl_list\prolist.html";i:1551764508;s:60:"D:\phpStudy\WWW\iwebsite\template\pc\default\_head_base.html";i:1551762885;s:57:"D:\phpStudy\WWW\iwebsite\template\pc\default\_header.html";i:1551763778;s:57:"D:\phpStudy\WWW\iwebsite\template\pc\default\_footer.html";i:1551433387;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="col-sm-4 sm-margin-b-50">
                    <div class="margin-b-20">
                        <div class="wow zoomIn" data-wow-duration=".3" data-wow-delay=".1s">
                            <img class="img-responsive" src="<?php echo $item['thunb']; ?>" alt="Our Exceptional Solutions Image">
                        </div>
                    </div>
                    <h3><a href="<?php echo $item['url']; ?>"><?php echo $item['title']; ?></a> <span class="text-uppercase margin-l-20"><?php echo $item['author']; ?></span></h3>
                    <p><?php echo $item['description']; ?></p>
                    <a class="link" href="<?php echo $item['url']; ?>">Read More</a>
                </div>
